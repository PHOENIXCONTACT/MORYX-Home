...
The second step highly depends on your own preferences, [here](./02_HowToAddAnAngularApplicationToYourUI.md) you can get an example on how to continue adding a single page application as the content of your UI with Angular.
