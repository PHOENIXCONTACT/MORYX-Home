...
Coming back to the Razor page you created in [How to create your UI](./01_HowToCreateYourUI.md) the following lines need to be added to the *MyModule.cshtml*.
